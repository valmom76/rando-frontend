...
export const createTenantTheme = (
  ...
  return {
    token: {
      ...
      colorTextDescription: "rgba(255,255,255,0.84)",
      colorTextTertiary: "rgba(255,255,255,0.80)",
      colorTextQuaternary: "rgba(255,255,255,0.72)",
    ...
    components: {
      ...
      Button: {
        ...
        defaultBorderColor: rgba(colors.primary, 0.5),
        defaultHoverColor: colors.primary,
        defaultHoverBg: rgba(colors.primary, 0.1),
        defaultHoverBorderColor: colors.primary,
        defaultActiveColor: colors.primary,
        defaultActiveBg: rgba(colors.primary, 0.16),
